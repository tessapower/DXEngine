...
MessageMap::MessageMap() : messages({
          ...
          REGISTER_MSG(WM_CHOOSEFONT_GETLOGFONT),
          REGISTER_MSG(WM_CHOOSEFONT_SETFLAGS),
          REGISTER_MSG(WM_CHOOSEFONT_SETLOGFONT),
          ...
          REGISTER_MSG(WM_MOVE),
                ...
                REGISTER_MSG(WM_PSD_ENVSTAMPRECT),
                REGISTER_MSG(WM_PSD_FULLPAGERECT),
                REGISTER_MSG(WM_PSD_GREEKTEXTRECT),
                REGISTER_MSG(WM_PSD_MARGINRECT),
                REGISTER_MSG(WM_PSD_MINMARGINRECT),
                REGISTER_MSG(WM_PSD_PAGESETUPDLG),
                REGISTER_MSG(WM_PSD_YAFULLPAGERECT),
...
std::string MessageMap::operator()(DWORD uMsg, WPARAM wParam, LPARAM lParam) const {
  ...
  if (messages.contains(uMsg)) {
    const std::string msg = messages.at(uMsg);
    out << msg;
  } else {
    out << "!! Unknown Message";
  }
